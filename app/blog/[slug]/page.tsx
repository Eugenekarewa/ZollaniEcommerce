    ...
    <div className="bg-white py-12">
      <div className="container-wide max-w-3xl">
        <Reveal>
          ...
          <div className="mt-8 flex h-64 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-coral-50 to-teal-50">
            <span className="text-6xl opacity-30 transition-transform duration-700 hover:scale-110 hover:rotate-3">📝</span>
          </div>
          ...
          <div className="mt-12 rounded-2xl bg-coral-50 p-8 text-center transition-all duration-300 hover:shadow-glow-coral">
