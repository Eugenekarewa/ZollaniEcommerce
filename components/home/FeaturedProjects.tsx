        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {featuredProjects.map((project) => (
            <div key={project.slug} className="card flex flex-col gap-4">
              {/* Placeholder image */}
              <div className="flex h-40 items-center justify-center rounded-xl bg-gradient-to-br from-coral-50 to-teal-50">
              ...
              <div className="flex-1">
                ...
                <h3 className="mt-2 font-bold text-charcoal">{project.title}</h3>
              ...
              {/* Outcome callout */}
              <div className="flex items-start gap-2 rounded-xl bg-coral-50 p-3">
