  ...
  return (
    <section className="bg-white py-20">
      <div className="container-wide">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-charcoal to-charcoal-light">
            <div className="glow-orb -right-16 -top-16 h-56 w-56 animate-float bg-coral/20" />
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="relative p-10 lg:p-14">
                ...
                <div className="mt-8 flex flex-col gap-3">
                  {categories.map((cat) => (
                    <div key={cat.label} className="group flex items-center gap-3 text-sm text-gray-300">
                      <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/10 text-coral transition-transform duration-300 group-hover:scale-110">
                        {cat.icon}
                      </span>
                      {cat.label}
                    </div>
              ...
              <div className="flex items-center justify-center bg-white/5 p-10">
                <div className="relative">
                  <div className="absolute inset-0 animate-pulse-glow rounded-full bg-gradient-brand opacity-20 blur-3xl" />
                  <div className="relative grid grid-cols-2 gap-4">
                    {['📱', '💻', '🎧', '🔌'].map((emoji, i) => (
                      <div
                        key={i}
                        className="flex h-20 w-20 animate-float items-center justify-center rounded-2xl bg-white/10 text-4xl backdrop-blur-sm transition-transform duration-300 hover:scale-110"
